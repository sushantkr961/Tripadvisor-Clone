import { Box, ListItem, SimpleGrid,Text,Stack  , UnorderedList,Image, Heading, WrapItem} from "@chakra-ui/react";
...
return <>
  ...
  '2xl': 2,
     ...
     <Box  fontFamily={"italic"} height='480px'  fontSize={"2xl"} textAlign="left" pt="10" pl="5"   boxShadow='2xl'>
        <Text >{obj.name}</Text>
        <Text>Star rating {obj.starRating}</Text>
        <Box mt="105" >
            <Text>Popular Aminities</Text>
            <UnorderedList listStyleType={"none"}>
            <WrapItem> <BiDrink/> <ListItem> Food-Drinks</ListItem>  </WrapItem> 
          <WrapItem  > <BiBeer/>  <ListItem>Working away</ListItem>  </WrapItem> 
          <WrapItem> <BiBed/> <ListItem>Home Comfort</ListItem>  </WrapItem> 
          <WrapItem> <BiCameraMovie/> <ListItem>Be Entrtained</ListItem>  </WrapItem> 
          <WrapItem> <AiOutlineWifi/> <ListItem>Free Wifi</ListItem>  </WrapItem> 
           </UnorderedList>
        </Box>
     </Box>
