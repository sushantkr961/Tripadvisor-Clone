...
const sortListHighTolow =()=>{
    let sortedData= list.sort((a,b)=>{
        if(a.max_price_in_usd < b.max_price_in_usd){ return 1}
        if(a.max_price_in_usd > b.max_price_in_usd){ return  -1}
          return 0;
       })
       setList([...sortedData])
...
<Button bg="white" onClick={sortListlowToHigh}>Low-To-High <FcNumericalSorting12/></Button>
</Box>
<Box bg='#d7d7d7' w='100%' p={4} color='black' ml={"none"}>
<Grid  templateColumns='repeat(1, 1fr)' gap={{ base:'2' ,xs:'3',lg:'5px',xl:'6px'}} w={{base:'100%',lg:'100%',xl:'70%'}} bg='white '  >
