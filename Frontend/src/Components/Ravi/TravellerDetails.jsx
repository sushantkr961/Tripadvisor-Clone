      ...
      <div className="box1">
        <div className="ContactDetails">
          <form>
            ...
            <Text as="b" marginBottom="50px">
              Traveller Details
            </Text>

            <Text fontSize="10px" fontWeight={"500"} marginBottom="10px">
              Lead Traveller
            </Text>
            ...
            <Text fontSize={"8px"}>
              The provider offers pickup from select hotels. Meet the provider
              at one of the listed hotels.
            </Text>
            <Input
              size="xs"
              fontSize={"10px"}
            ...
            <br />
            <Link to="/payment">
              <Button colorScheme="red" width={"90%"} onClick={handleForm}>
                Next
              </Button>
            </Link>
            <br />
            <br />
            <Text fontSize={"8px"}>
              © 2022 TripAdvisor LLC All rights reserved. Tripadvisor Terms of
